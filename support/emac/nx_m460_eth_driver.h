...
#define NX_DRIVER_TX_DESCRIPTORS   TRANSMIT_DESC_SIZE
#endif

#ifndef NX_DRIVER_RX_DESCRIPTORS
#define NX_DRIVER_RX_DESCRIPTORS   RECEIVE_DESC_SIZE
#endif
